package com.example.application.views.medicationadministartionsheet;
...
@PageTitle("Medication Administartion Sheet")
@Route(value = "Medication-Administartion-Sheet", layout = MainLayout.class)
@PermitAll
public class MedicationAdministartionSheetView extends Div {
    ...
    public MedicationAdministartionSheetView() {
        addClassName("medication-administartion-sheet-view");
        setSizeFull();
        createGrid();
        add(grid);
    }
