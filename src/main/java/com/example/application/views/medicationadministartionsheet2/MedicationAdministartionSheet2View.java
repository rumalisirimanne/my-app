package com.example.application.views.medicationadministartionsheet2;
...
@PageTitle("Medication Administartion Sheet2")
@Route(value = "Medication-Administartion-Sheet2", layout = MainLayout.class)
@PermitAll
public class MedicationAdministartionSheet2View extends Div {
    ...
    public MedicationAdministartionSheet2View() {
        addClassName("medication-administartion-sheet2-view");
        setSizeFull();
        createGrid();
        add(grid);
    }
